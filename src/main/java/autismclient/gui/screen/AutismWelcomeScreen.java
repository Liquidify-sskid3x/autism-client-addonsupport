...
public class AutismWelcomeScreen extends Screen {
    ...
    private static final String[][] SECTIONS = {
        {"Updates & Community",
            "Join the Discord for updates, to share suggestions, get help, or just to see what I'm working on."},
        {"Donate",
    ...
    private final Btn discord = new Btn("discord", "Discord", DISCORD_SUPPORT_ICON, SUPPORT_ICON_WIDTH, SUPPORT_ICON_HEIGHT, () -> AutismLinks.open(AutismLinks.DISCORD));
    private final Btn donate = new Btn("donate", "Donate", DONATE_SUPPORT_ICON, SUPPORT_ICON_WIDTH, SUPPORT_ICON_HEIGHT, () -> AutismLinks.open(AutismLinks.KOFI));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        try {
            ...
            renderButton(graphics, discord, uiMouseX, uiMouseY, true);
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean doubleClick) {
        ...
        layout();
        if (discord.contains(mx, my)) { press(discord, mx, my); return true; }
    ...
    private void layout() {
        ...
        int bx = cardX + PAD;
        discord.set(bx, btnY, btnW, BUTTON_HEIGHT);
        donate.set(bx + btnW + BUTTON_GAP, btnY, btnW, BUTTON_HEIGHT);
